...
namespace Life
{
    class Bird : Life, IAnimals
    {
        ...
        public Bird() { this.name = "Unknown bird"; this.age = 0; this.height = "0\'0"; this.weight = 0; this.awake = false; this.attack = 0; }

        ~Bird() { System.Diagnostics.Trace.WriteLine("Bird's destructor is called.\n"); }

        public Bird(string n, int a, string h, double w, bool aw, int atk)
        {
            this.name = n;
            this.age = a;
            this.height = h;
