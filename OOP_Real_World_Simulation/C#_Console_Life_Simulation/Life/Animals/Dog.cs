...
namespace Life
{
    class Dog : Life, IAnimals
    {
        ...
        public Dog() { this.name = "Unknown dog"; this.age = 0; this.height = "0\'0"; this.weight = 0; this.awake = false; this.attack = 0; }

        ~Dog() { System.Diagnostics.Trace.WriteLine("Dog's destructor is called.\n"); }

        public Dog(string n, int a, string h, double w, bool aw, int atk)
        {
            this.name = n;
            this.age = a;
            this.height = h;
